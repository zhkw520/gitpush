	...
	<div class="HomeBox">
		<div class="HomeBox_n">
			<div class="HomeBox_nl">			
				...
				<div class="Hcentbox">
					<div @click="tzd('/datas')"><div><img src="/img/datas.png"></div><div>广告位数据</div></div>
					<div @click="tzd('/xq/xqlist')"><div><img src="/img/xq_xqlist.png"></div><div>需求管理</div></div>
					<div @click="tzd('/xq/materialLibt?type=picture')"><div><img src="/img/xq_materialLibt_picture.png"></div><div>广告图投放管理</div></div>
					<div @click="tzd('/xq/materialLib?type=resource')"><div><img src="/img/xq_materialLib_resource.png"></div><div>广告图模板管理</div></div>
					<div @click="tzd('/xq/external')"><div><img src="/img/xq_external.png"></div><div>外部账号管理</div></div>					
				</div>
				</div>
				<div class="HomeBox_nlxf">
			...
			<div class="HomeBox_nr">
				<div class="homBoxlboxt ndf">登陆记录</div>
				<div class="homBoxr2">
