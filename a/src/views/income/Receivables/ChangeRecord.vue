    ...
    <div>
        <div class="top">
            <div class="tit_top_url">
                ...
                <span class="log_url" @click="jumps()">&nbsp;收款结算详情&nbsp;/</span>
...
<script>
    export default {
        ...
        methods:{
            ...
            getData(){
                let params={is_receiver:1,search:this.search,p:this.p,page:this.page,tstart:this.time[0],tend:this.time[1],id:this.$route.query.id};
