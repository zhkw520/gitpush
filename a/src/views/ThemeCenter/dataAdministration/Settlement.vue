    ...
    export default {
        ...
        methods:{
            ...
            getData(){
                ...
                if(!this.creator){
                  var params=  {data_type:'2',tstart:this.value[0],tend:this.value[1],p:this.p,page:this.page};
                }else{
                    params={data_type:'2',tstart:this.value[0],tend:this.value[1],p:this.p,page:this.page,creator:this.creator};
                }
